...
export default {
  ...
  methods:{
    ...
    endtimeShow:function(){
      if(this.mblx==='xtmb'){
          // this.$router.push({path:'./set_tx_xtmb',query:{mbxq:this.mbxq,mblx:this.mblx}});
          this.$router.push('./set_tx_xtmb');
      }else if(this.mblx==='xymb'){
          this.$router.push('./set_tx');
          // this.$router.push({path:'./set_tx',query:{mbxq:this.mbxq,mblx:this.mblx}});
