...
export default {
	...
	methods:{
		zmbShow:function(id){
			// console.log(this.mblx);
			var _this = this;
           this.$http.get('http://192.168.0.101:8081/target/target_zmblb?userid=11204050220&id=fa8dc10a4b6e4212ad308a5e5eb37496&function_id=20150101&ticket=B110E55DEECA941AEFDCF9CE72C2789D').then(res=>{
            _this.zmbList=res.data.content;
            console.log(_this.zmbList);
			this.$router.push({path:'./collegegoal_addzmb',query:{zmbList:JSON.stringify(this.zmbList),gjdid:id,mblx:'xymb'}});
        })
		},
		bzShow:function(){
